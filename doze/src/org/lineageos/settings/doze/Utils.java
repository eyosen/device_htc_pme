...
public final class Utils {
    ...
    protected static boolean isPickUpEnabled(Context context) {
        if (DEBUG) Log.d(TAG, "Gesture: pick up" + " State: " + isGestureEnabled(context, GESTURE_PICK_UP_KEY));
        return isGestureEnabled(context, GESTURE_PICK_UP_KEY);
    }

    protected static boolean isHandwaveGestureEnabled(Context context) {
        if (DEBUG) Log.d(TAG, "Gesture: handwave" + " State: " + isGestureEnabled(context, GESTURE_HAND_WAVE_KEY));
        return isGestureEnabled(context, GESTURE_HAND_WAVE_KEY);
    }

    protected static boolean isPocketGestureEnabled(Context context) {
        if (DEBUG) Log.d(TAG, "Gesture: pocket" + " State: " + isGestureEnabled(context, GESTURE_POCKET_KEY));
